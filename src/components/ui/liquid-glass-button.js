...
/**
 * Komponen LiquidButton - Button dengan efek liquid glass yang modern
 * Dikonversi dari TypeScript ke JavaScript untuk kompatibilitas
 * 
 * Fitur:
 * - Efek glass morphism dengan shadow kompleks
 * - SVG filter untuk distorsi liquid
 * - Hover dan active states yang smooth
 * - Support berbagai size dan variant
 */
...
const colorVariants = {
  ...
  violet: {
    outer: "bg-gradient-to-b from-[#4c1d95] to-[#a78bfa]",
    inner: "bg-gradient-to-b from-[#ddd6fe] via-[#5b21b6] to-[#c4b5fd]",
    button: "bg-gradient-to-b from-[#a78bfa] to-[#7c3aed]",
    textColor: "text-white",
    textShadow: "[text-shadow:_0_-1px_0_rgb(76_29_149_/_100%)]",
  },
  success: {
